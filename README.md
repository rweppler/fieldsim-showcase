...
| 08 | `/showdown/` | **Captain Theory** | The Showdown/Captain-Mode engine | Stadium night broadcast, Chakra Petch, floodlights + LED ticker | The captain dial: tap a player, his points AND salary ×1.5 — Allen busts the cap by exactly $200, Mahomes lands on exactly $50,000. Doctrine cards from the real engine. |
